		...
		>
			...
			<div className='space-y-6'>
				...
				>
					...
					<div className="text-gray-300 flex gap-1"><span className=' font-bold'>Name:</span><span>{user.name}</span></div>
					<div className="text-gray-300 flex gap-1"><span className=' font-bold'>Email:</span><span>{user.email}</span></div>
				</motion.div>
				<motion.div
					className='p-4 bg-gray-800 bg-opacity-50 rounded-lg border border-gray-700'
					initial={{ opacity: 0, y: 20 }}
